...
{
	CallParameters params{_senderAddress, _receiveAddress, _receiveAddress, _value, _value, _gas, _data, false, {}};
...
bool Executive::call(CallParameters const& _p, u256 const& _gasPrice, Address const& _origin)
{
	...
	else
	{
		...
		if (m_s.addressHasCode(_p.codeAddress))
		{
			...
			m_ext = make_shared<ExtVM>(m_s, m_envInfo, m_sealEngine, _p.receiveAddress, _p.senderAddress, _origin, _p.apparentValue, _gasPrice, _p.data, &c, codeHash, m_depth, _p.throwOnStateChanging);
		}
	}
